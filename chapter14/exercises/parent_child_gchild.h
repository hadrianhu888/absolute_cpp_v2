 ...
 *
 */
#ifndef PARENT_CHILD_GCHILD_H
#define PARENT_CHILD_GCHILD_H
...
namespace gchild
{
    class GChild:public child::Child
    {
        private:
            int gchild_private;
        protected:
...
void saveParentChildGChildToDataTimeStampedFile(parent::Parent &p, child::Child &c, gchild::GChild &g, int length, string filename);

#endif // PARENT_CHILD_GCHILD_H
